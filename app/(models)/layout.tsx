...
const pageDescription = `Browse ${totalModels} models across ${totalProviders} providers form Vercel AI Gateway in Sparka AI. Filter and compare by provider, context window, and pricing.`;
